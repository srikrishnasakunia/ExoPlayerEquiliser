package dev.krishna.exoplayerequiliser.data.storage
...
class EqualizerPreference @Inject constructor(
    @param:Named(AUDIO_EFFECT_PREFERENCES)
    ...
    var audioEffect: AudioEffects?
        ...
        set(audioEffects) {
            ...
            sharedPreferences.edit()
                .putString(AUDIO_EFFECT_EQUALIZER_SETTING, json)
                .apply()
        }
